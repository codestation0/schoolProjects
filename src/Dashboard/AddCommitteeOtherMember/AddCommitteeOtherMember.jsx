...
const AddCommitteeOtherMember = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/add-committee`,
      formDataToSend,
      {
        headers: {
  ...
  return (
    <div className="max-w-screen-lg mx-auto mt-5  w-full ">
      <FormTitle title={"Add Committee Member Information"} />
      <form
...
export default AddCommitteeOtherMember;

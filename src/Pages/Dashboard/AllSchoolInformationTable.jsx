...
import SchoolInfoRow from "../../Components/Dashboard/SchoolInformationRow";
import Container from "../Shared/Container";

const AllSchoolInformationTable = () => {
  const { data: schoolInfo = [], refetch } = useQuery({
    queryKey: ["all-school-information"],
    queryFn: async () => {
...
export default AllSchoolInformationTable;
